...
export class Backend implements backendInterface {
    ...
    async getAyatByIndex(arg0: bigint): Promise<Ayat> {
        if (this.processError) {
            try {
                const result = await this.actor.getAyatByIndex(arg0);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getDayIndex(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getDayIndex();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTodayAyat(): Promise<Ayat> {
        if (this.processError) {
            try {
                const result = await this.actor.getTodayAyat();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTotalAyat(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getTotalAyat();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
